...
vex::motor drive_r1 = vex::motor(PORT12, DRIVE_INSERT, false);
...
vex::motor drive_l1 = vex::motor(PORT6, DRIVE_INSERT, false);
vex::motor drive_l2 = vex::motor(PORT5, DRIVE_INSERT, true);
vex::motor drive_l3 = vex::motor(PORT4, DRIVE_INSERT, true);
// vex::motor drive_l4 = vex::motor(PORT8, DRIVE_INSERT, false);

// Subsystem 3
vex::motor intakeLow = vex::motor(PORT8, INTAKE_INSERT, false);
vex::motor intakeHigh = vex::motor(PORT9, INTAKE_INSERT, true);

vex::motor lift = vex::motor(PORT20, vex::gearSetting::ratio18_1, false);
...
// Sensors
vex::inertial imu = vex::inertial(PORT19);
