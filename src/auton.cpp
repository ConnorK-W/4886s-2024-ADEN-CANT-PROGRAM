...
void autonomous(void) {
    ...
    case RightSimple: {
        ...
        drive_full.spin(DIR_REV, 50, VEL_PCT);
        drive_turn(135, 14, 35, 125, false, 0, 0);
        vex::thread t2([](){
            wait(500, TIME_MSEC);
            tounge.set(1);
            wait(400, TIME_MSEC);
        ...
        drive_straight(30, 20, 50, true, 10, 30);
        t4.interrupt();
        wait(1000, TIME_MSEC);
        t1.interrupt();
        t2.interrupt();
    ...
    case RightComplex: {
        ...
        tounge.set(0);
        turn_pid(-180, -1, 1);
        drive_straight(33, 70, 100, true, 40, 30);
        currentState = IntakeState::OUTTAKE_LIFT; 
        drive_full.spin(DIR_FWD, 5, VLT_VLT);
        wait(1000, TIME_MSEC);
        ...
        hood.set(0);
        drive_straight(38, 30, 100, true, 5, 5);
        turn_pid(-35, -1, 1);
    ...
    case SKILLS: {
        ...
        drive_full.spin(DIR_REV, 2, VLT_VLT);
        wait(500, TIME_MSEC);
        drive_full.spin(DIR_REV, 6, VLT_VLT);
        wait(900, TIME_MSEC);
        drive_full.spin(DIR_FWD, 2, VLT_VLT);
        wait(1000, TIME_MSEC);
        drive_straight(-4, 60, 70, true, 0, 5);
        turn_pid(90, -1, 1);
        drive_straight(37, 60, 70, true, 0, 5);
        turn_pid(135, -1, 1);
        drive_straight(25, 60, 70, true, 0, 5);
        turn_pid(180, -1, 1);
        drive_straight(-13, 30, 50, true, 0, 20);
        lift.set(1);
        wait(1000, TIME_MSEC);
        currentState = IntakeState::SCORE_MID_SLOW;
        wait(3000, TIME_MSEC);
        drive_straight(1, 30, 30, true, 0, 5);
        drive_full.spin(DIR_REV, 2, VLT_VLT);
        wait(800, TIME_MSEC);
        drive_straight(39, 60, 30, true, 0, 15);
        currentState = IntakeState::INTAKE;
        lift.set(0);
        tounge.set(1);
        drive_turn(-45, -15, 60, 75, false, 15, 10);
        drive_straight(10, 30, 70, true, 10, 10);
        drive_full.spin(DIR_FWD, 3, VLT_VLT);
        wait(1000, TIME_MSEC);
        drive_straight(-2, 30, 70, true, 10, 10);
        drive_full.spin(DIR_FWD, 3, VLT_VLT);
        wait(1000, TIME_MSEC);
        ...
        vex::thread t2([](){
            ...
            target_heading = 90 + 540;   

        });
        drive_straight_toward_goal(2900, false, false);
        // second match load
        t2.interrupt();
