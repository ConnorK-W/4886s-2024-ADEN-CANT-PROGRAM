...
void autonomous(void) {
    ...
    case AWP: {
        ...
        finger.set(1);
        drive_turn(90, 13, 40, 75, false, 20, 0);
        ...
        t1.interrupt();
        drive_straight(37, 75, 100, true, 0, 20);
        tounge.set(1);
        drive_turn(-80, -26, 75, 100, false, 20, 2);
        drive_straight(5, 30, 70, true, 0, 10);
    ...
    case RightComplex: {
        ...
        tounge.set(0);
                tounge.set(0);
        drive_straight_toward_goal(3000, 0);
        scoring = 4;
        wait(1000, TIME_MSEC);
        drive_turn(-90, -13, 50, 75, false, 0, 0);
        t1.interrupt();
    ...
    case LeftSimple: {
        ...
        wait(600, TIME_MSEC);
        lift.set(1);
        drive_turn(42.5, -17, 70, 75, true, 0, 15);
        drive_straight(-35, 75, 100, true, 15, 30);
        drive_straight_toward_goal(2000, 1, false);
        scoring = 3;
        wait(1000, TIME_MSEC);
        t1.interrupt();
...
void intake() {
    ...
    while (true) {
        ...
        case 5: {
            ...
            hood.set(1);
            intakeLow.spin(DIR_FWD, 100, VEL_PCT);
            intakeHigh.spin(DIR_FWD, 80, VEL_PCT);
            break;
        }
        case 6: {
