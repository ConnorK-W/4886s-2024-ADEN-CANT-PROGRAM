...
enum class IntakeState { OFF, INTAKE, OUTTAKE, OUTTAKE_LIFT, SCORE, SCORE_SLOW, HALF_SCORE, SCORE_MID, SCORE_MID_SLOW, INTAKE_HOOD };
...
void autonomous(void) {
    ...
    case AWP: {
        ...
        lift.set(0);
        tounge.set(1);
        drive_straight(16, 70, 100, true, 0, 40);
        drive_turn(70, 15, 65, 75, false, 40, 0);
        target_heading = 90;
        ...
        drive_turn(120, 12, 55, 125, false, 0, 20);
        target_heading = 225;
        vex::thread t2([](){
            wait(200, TIME_MSEC);
            tounge.set(1);
        ...
        t4.interrupt();
        wait(1500, TIME_MSEC);
        drive_straight(-4, 30, 50, true, 20, 10);
        currentState = IntakeState::INTAKE; 
        drive_turn(-50, 16, 40, 70, true, 10, 0);
        drive_straight(38, 75, 100, true, 0, 20);
        tounge.set(1);
        drive_turn(-85, -35, 50, 100, false, 20, 10);
    ...
    case AWPPush: {
        vex::thread t1(intake);
        drive_straight(3, 70, 100, true, 0, 15);
        drive_straight(-51, 60, 80, true, 0, 5);
        tounge.set(1);
        turn_pid(-90, -1, 1);
        ...
        drive_straight_toward_goal(1200, 0, false);
        tounge.set(0);
        ...
        wait(900, TIME_MSEC);
        lift.set(0);
        drive_straight(35, 50, 100, true, 0, 40);
        drive_turn(-35, -25, 50, 100, false, 40, 20);
        target_heading = -90;
    ...
    case RightSimple: {
        ...
        lift.set(0);
        tounge.set(1);
        drive_straight(17, 70, 100, true, 0, 40);
        drive_turn(70, 15, 65, 75, false, 40, 0);
        target_heading = 90;
        drive_full.spin(DIR_FWD, 4, VLT_VLT);
        wait(700, TIME_MSEC);
        ...
        drive_straight_toward_goal(1300, false, false);
        drive_full.spin(DIR_REV, 50, VEL_PCT);
        drive_straight(1.5, 70, 100, true, 0, 40);
        drive_turn(120, 11.9, 55, 125, false, 0, 20);
        target_heading = 225;
        vex::thread t2([](){
            wait(200, TIME_MSEC);
            tounge.set(1);
        ...
        drive_full.stop();
        drive_full.setStopping(vex::hold);
        drive_turn(-30, 0, 55, 125, false, 0, 0);
    ...
    case RightWing: {
        ...
        tounge.set(0);
        // mid goal
        drive_turn(-45, 27, 70, 75, true, 0, 5);
        tounge.set(0);
        turn_pid(-180, -1, 1);
        vex::thread t3([](){
            wait(200, TIME_MSEC);
        ...
        drive_turn(-135, 19, 70, 75, true, 10, 10);
        vex::thread t2([](){
            target_heading = target_heading - 15;
            wait(500, TIME_MSEC);
            target_heading = target_heading + 15;
            wait(3000, TIME_MSEC);
            intakeFull.spin(DIR_FWD, 100, VEL_PCT);
        ...
        currentState = IntakeState::OFF;
        drive_straight(-15, 30, 100, true, 10, 5);
        t1.interrupt();
        hood.set(0);
        drive_straight(34, 30, 100, true, 5, 5);
        turn_pid(-35, -1, 1);
        drive_straight_toward_goal(3000, false, false);
        t2.interrupt();
    ...
    case LeftSimple: {
        ...
        lift.set(0);
        tounge.set(1);
        drive_straight(14, 70, 100, true, 0, 40);
        ...
        drive_straight_toward_goal(1300, false, false);
        drive_full.spin(DIR_REV, 50, VEL_PCT);
        drive_turn(-135, -13.8, 40, 125, false, 0, 0);
        lift.set(1);
        ...
        drive_straight(-9, 70, 100, true, 0, 5);        
        //drive_straight_toward_goal(1000, 1, false);
        wait(1400, TIME_MSEC);
        t1.interrupt();
        t2.interrupt();
        hood.set(0);
        ...
        drive_straight(-23, 30, 100, true, 0, 5);
        drive_full.setStopping(vex::hold);
        t3.interrupt();
        wait(10000, TIME_MSEC);
    ...
    case LeftComplex: {
        ...
        drive_turn(-135, -11, 75, 125, false, 0, 3);
        hood.set(1);
        turn_pid(180, -1, 1);
        drive_straight(-15,  75, 100, true, 0, 40);
        break;
    }
    ...
    case SKILLS: {
        ...
        drive_straight(32, 70, 100, true, 0, 10);
        drive_turn(-80, -15, 40, 75, false, 10, 20);
        target_heading = -90;
        drive_full.spin(DIR_FWD, 5, VLT_VLT);
        wait(2000, TIME_MSEC);
        ...
        drive_straight(85, 70, 70, true, 0, 10);
        turn_pid(-30, -1, 1);
        tounge.set(1);
        ...
        // long goal
        // drive_straight(-35, 50, 70); // straight
        drive_straight_toward_goal(1200, false, false); // try lowering
        currentState = IntakeState::SCORE_SLOW; 
        ...
        currentState = IntakeState::INTAKE; 
        hood.set(1);
        drive_straight(85, 70, 70, true, 0, 3);
        turn_pid(-30, -1, 1);
        tounge.set(1);
        // drive_straight(-15, 50, 70); // straight
        // long goal
        ...
        drive_straight(-25, 70, 100, true, 0, 30);
        currentState = IntakeState::SCORE;
        drive_straight_toward_goal(1500, false, false);
        tounge.set(0);
        drive_turn(85, 39.5, 50, 75, false);
        vex::thread t6([](){
            wait(800, TIME_MSEC);
            tounge.set(1);
        });
...
void intake() {
    ...
    while (true) {
        switch (currentState) {
            ...
            case IntakeState::SCORE_MID_SLOW:
                hood.set(0);
                intakeFull.spin(DIR_FWD, 100, VEL_PCT);
                arm.spin(DIR_FWD, 15, VEL_PCT);
                break;
